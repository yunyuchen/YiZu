...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarBackgroundImage =  [UIImage navigationBarBackgroundImageWithThemeColor:[UIColor colorWithHexString:@"#FFFFFF"]];                                        // NavBarBackgroundImage : UINavigationBar 的背景图
