...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.panView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"取色器"]];
        self.panView.frame = CGRectMake(0, 0, 30, 30);
        self.panView.center = CGPointMake(frame.size.width * 0.5, frame.size.height * 0.5);
